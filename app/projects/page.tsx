...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      role: "creator",
      period: "2026 - present",
      description: "a framework-agnostic testing methodology and 58-block universal test battery for autonomous ai agents.",
      achievements: [
        "61-source benchmark map spanning function calling, web, os, and memory",
        "58-block universal test battery covering l1–l4 capabilities and error recovery",
        "owasp top 10 for agentic applications taxonomy and automated red-teaming",
      ],
      technologies: ["agentic workflows", "benchmarking", "llm security", "owasp", "evaluations"],
